...
int ice::get_quantil_border(const Image& pic, const Contur& c,
...
int ice::get_quantil_border(const Image& pic, int threshold, Window& win)
{
...
int
ice::normalizeSeg(const Image& segImgInput, Image normedSeg,
