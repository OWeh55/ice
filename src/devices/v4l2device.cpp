            ...
            while ((xioctl(fd, VIDIOC_ENUM_FRAMESIZES, &fs)) == 0)
              {
                if (fs.type == V4L2_FRMSIZE_TYPE_DISCRETE)
                  ...
                  {
                    /*
                      cout << "width: " << fs.stepwise.min_width << " .. ";
                      cout << fs.stepwise.max_width << " step: " ;
                      cout << fs.stepwise.step_width << endl;
                      cout << "height: " << fs.stepwise.min_height << " .. ";
                      cout << fs.stepwise.max_height << " step: " ;
                      cout << fs.stepwise.step_height << endl;
                    */
